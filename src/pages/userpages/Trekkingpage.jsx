  ...
  return (
    <div className="bg-gray-100 ">
      ...
      <div className="py-12 px-6 text-center">
        <p className="text-gray-700 text-lg max-w-6xl mx-auto mobile:text-justify medium:text-justify">Trekking is an adventurous activity that requires walking in a wild natural environment for multiple days. Nepal offers numerous trekking trails including the Everest Base Camp Trek, Annapurna Base Camp Trek, Langtang Trek, and many more.</p>
      </div>
      <div className="container max-w-6xl my-8 mx-auto mobile:px-4 medium:px-6">
