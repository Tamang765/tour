  ...
  return (
    <div className="bg-gray-100 ">
      ...
      <div className="py-12  text-justify">
        <p className="text-gray-700 text-lg w-full lg:px-[5rem]  md:px-[3rem] sm:px-[2rem] px-[1rem] ">Trekking is an adventurous activity that requires walking in a wild natural environment for multiple days. Nepal offers numerous trekking trails including the Everest Base Camp Trek, Annapurna Base Camp Trek, Langtang Trek, and many more.</p>
      </div>
      <div className="w-full lg:px-[5rem] md:px-[3rem] sm:px-[2rem] px-[1rem] my-8  ">
