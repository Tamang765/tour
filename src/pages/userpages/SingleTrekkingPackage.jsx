      ...
      <div className="  bg-white">
        <div className="border-b">
          <div className="container mx-auto max-w-6xl flex flex-col lg:flex-row justify-between items-center ">
            <div className="flex flex-wrap justify-center space-x-6 text-gray-800 text-md lg:text-base font-semibold">
        ...
        <section id="description" className="container mx-auto max-w-6xl mt-8 lg:flex lg:space-x-8">
        ...
        <section id="reviews" className="container mx-auto max-w-6xl my-12">
